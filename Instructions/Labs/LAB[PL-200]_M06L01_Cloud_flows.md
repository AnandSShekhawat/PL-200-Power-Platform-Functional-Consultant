...
1. Select the **Request Approval** flow, click on the ellipses **(⋮)**, and select **Edit**>**Edit in new tab**.
...
1. In **Dynamic content**, search for **approver** and select **Approver Email (1)**.

1. Change the **Operator** to **is not equal to (2)**.

1. Click in the right-hand **Choose a value (3)** field.

1. In **Dynamic content**, select the **Expression** tab.

1. Enter `null` and click **OK**.

    ![](../media/pl200-p22t1p3.png)
...
1. Enter **No approver for outcome** and in **Dynamic content** select **Outcome Title** for message.
...
1. Enter `Set Outcome to rejected` **(1)**.

1. Select `Outcomes` for **Table name (2)**.

1. Click in the **Row ID** field.

1. In **Dynamic content**, search for `outcome` and select **Outcome (3)** under the **Get Outcome** section.

1. Expand **Show advanced options**.

1. Select **No** for **Approved (4)**.

1. Select **Rejected** for **Status Reason (5)**.

    ![](../media/pl200-p22t1p9.png)
...
1. Paste the URL from the previous task **(1)**.
...
1. Click **+ New** > **Automation** > **Cloud flow** > **Automated**.
    ...
    ![](../media/pl200-p22t3p1.png)

1. Enter `Set Project End Date` for **Flow name (1)**

1. Search for `Dataverse` **(2)** in **Chose how to trigger this flow** and select the **When a row is added, modified, or deleted (3)** action.

1. Click **Create (4)**.

    ![](../media/pl200-p22t3p2.png)

1. Select **Modified** for **Change type (1)**.

1. Select **Projects** for **Table name (2)**.

1. Select **Organization** for **Scope (3)**.

1. Select the ellipses **(...)** and select **Rename**.

1. Enter `Project Status changed` **(4)**.

    ![](../media/pl200-p22t3p3.png)
...
1. Select **Projects** for **Table name (1)**.

1. Click in the **Row ID** field.

1. In **Dynamic content**, search for project and select **Project (2)**.
...
1. Enter `utcNow()` **(3)** and click **OK**.

    ![](../media/pl200-p22t3p4.png)
...
1. In the property selector underneath the header, select the dropdown. Find and select **DisplayMode (1)**. In the formula box next to the property selector, enter the following formula **(2)**:

    ```
    If(MilestoneGallery.Selected.'Milestone Percentage Complete' > 0, DisplayMode.Edit, DisplayMode.Disabled)
    ```

    ![](../media/pl200-p22t4p1.png)
...
1. Enter `Alex` in **Enter a name, email address, or Everyone** and select **Alex Wilber (2)**.

1. Select **Share (3)**.

    ![](../media/pl200-p22t4p2.png)

1. Enter `Megan` in **Enter a name, group, or email** and select **Megan Brown (1)**.

1. Expand the security role dropdown **(2)**, which looks like an eye icon next to Megan's name. Select **Co-owner (3)**.

    ![](../media/pl200-p22t4p4.png)
